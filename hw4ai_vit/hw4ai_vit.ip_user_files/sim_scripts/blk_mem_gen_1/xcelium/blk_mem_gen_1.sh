...
#
# Script generated by Vivado on Mon Apr 06 19:35:17 IST 2026
...
design_libs_elab="-libname xpm -libname blk_mem_gen_v8_4_11 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm blk_mem_gen_v8_4_11 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "blk_mem_gen_1.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/salla-kaushik/Documents/Semester_8/HW4AI/ViT-Malware-Detector/hw4ai_vit/hw4ai_vit.cache/compile_simlib/xcelium"
  fi
