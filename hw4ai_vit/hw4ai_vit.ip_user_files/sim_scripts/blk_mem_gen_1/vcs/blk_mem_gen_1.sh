...
design_libs=(xpm blk_mem_gen_v8_4_11 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_11 $vlogan_opts +v2k +incdir+"../../../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/salla-kaushik/Documents/Semester_8/HW4AI/ViT-Malware-Detector/hw4ai_vit/hw4ai_vit.cache/compile_simlib/vcs"
  fi
