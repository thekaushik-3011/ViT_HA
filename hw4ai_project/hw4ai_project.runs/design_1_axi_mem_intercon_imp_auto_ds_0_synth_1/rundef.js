...
ISEStep( "vivado",
         "-log design_1_axi_mem_intercon_imp_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_mem_intercon_imp_auto_ds_0.tcl" );
